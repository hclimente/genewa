vegas2.nf --bfile genesis_2019 --genome 37 --buffer 50000 --vegas_params '-top 20 -chr 23' -resume -profile bigmem
mv scored_genes.vegas.txt scored_genes.X.vegas.txt

vegas2.nf --bfile genesis_2019 --genome 37 --buffer 50000 --vegas_params '-top 20' -resume -profile bigmem
