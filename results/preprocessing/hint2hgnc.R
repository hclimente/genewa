...
hint <- bind_rows(read_tsv('HomoSapiens_htb_hq.txt', col_types = 'ccccccccc'),
                  read_tsv('HomoSapiens_htc_hq.txt', col_types = 'ccccccccc')) %>%
...
write_tsv(correct_genes, 'hint.ht_complex.hgnc.pseudo.tab2')
