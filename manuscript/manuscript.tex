...
\author{Héctor Climente-González$^{1,2,3}$, Christine Lonjou$^{1,2,3}$, Fabienne Lesueur$^{1,2,3}$, GENESIS study collaborators, Dominique Stoppa-Lyonnet$^{4,5,6}$, Nadine Andrieu$^{1,2,3}$, Chloé-Agathe Azencott$^{3,1,2}$}
...
\hypersetup{
  pdfauthor={Héctor Climente-González, Christine Lonjou, Fabienne Lesueur, GENESIS investigators, Dominique Stoppa-Lyonnet, Nadine Andrieu, Chloé-Agathe Azencott},
