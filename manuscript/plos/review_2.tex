...
\begin{flushleft}
{\Large
\textbf\newline{How can biological networks boost GWAS? A case study on susceptibility to familial breast cancer} % Please use "sentence case" for title and headings (capitalize only the first word in a title (or heading), the first word in a subtitle (or subheading), and any proper nouns).
}
\newline
